...
from core.model.utils.utils import skip_sum, skip_concat
from core.model.utils.basic_models import (
    ConvLayer,
    BasicBlock,
    TransposedConvLayer,
    UpsampleConvLayer,
...
class BaseUNet(nn.Module):
    ...
    def build_resblocks(self):
        ...
        for i in range(self.num_residual_blocks):
            resblocks.append(BasicBlock(self.max_num_channels, self.max_num_channels))
        return resblocks
